...
function CheckAlarmBuildingAction:waitToStart()
	--if self.obj == door or self.obj == window then
	if instanceof(self.obj, "IsoDoor") or instanceof(self.obj, "IsoWindow") then
